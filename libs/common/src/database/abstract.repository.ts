...
export abstract class AbstractRepository<TDocument extends AbstractDocument> {
    ...
    async findOneUpdate(filterQuery: FilterQuery<TDocument>, update: UpdateQuery<TDocument>): Promise<TDocument> {
    ...
    async find(filterQuery: FilterQuery<TDocument>): Promise<TDocument[]> {
        return this.model.findOneAndUpdate(filterQuery).lean<TDocument[]>(true);
    }
